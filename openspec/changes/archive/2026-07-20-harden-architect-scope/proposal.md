...
CLO`SED`: deny writes unless the agent is positively identified as authorized.

## What Changes

- Invert the write decision to default-deny for the design-artifact boundary.
- **BREAKING** for any workflow that relied on architect-scope doing nothing for non-architect
