...
Praise of the project ("well-Architected," "reliable," "mature"), any number not in the
model, speculation about intent or future work, and the LLM tells (examine, direct,
central, result, "not just X but Y"). State a measurable fact or nothing.
