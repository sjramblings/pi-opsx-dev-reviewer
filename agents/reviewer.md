...
- You hold **no write or edit tool**: you cannot author a change, only judge one. That
...
- **Reproduce before you trust.** The raw output pasted into the `Task:` string is an artifact
  ...
  pasted output is a weaker verdict, and green mocked tests have hidden broken code before.
